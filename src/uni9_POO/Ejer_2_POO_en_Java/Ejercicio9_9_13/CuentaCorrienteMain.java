...
/**
 * Implementa la clase {@code CuentaCorriente}. Cada cuenta corriente tiene un número de cuenta de 10 dígitos.
 ...
 * Se permite el saldo negativo. En el siguiente capítulo se propone un ejercicio como mejora de éste, en el que se pide
